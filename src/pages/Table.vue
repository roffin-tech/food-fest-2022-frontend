<template>
    ...
    <section class="order-section">
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            <div class="row">
                <div class="input-box">
                    <label for="oPeople">Seating Type</label>
                    <input type="number" name="stype" id="stype" v-model="orderObj.styp">
                    <p v-if="errorObj.stypErr.length > 0">{{ errorObj.stypErr[0] }}</p>
                </div>
                </div>
                <div class="row">
                <div class="input-box">
                    <label for="oPeople">Table Number</label>
                    <input type="number" name="ttype" id="ttype" v-model="orderObj.ttyp">
                    <p v-if="errorObj.ttypErr.length > 0">{{ errorObj.ttypErr[0] }}</p>
                </div>
                </div>
            <div class="row">
                <div class="input-box">
...
export default {
    ...
    data() {
        return {
            orderObj: { styp:"",ttyp:"", people: "", when: "", note: "" },
            errorObj: { stypErr: [], ttypErr: [], peopleErr: [],  whenErr: [] },
        }
    },
    ...
    methods: {
        ...
        resetCheckErr: function () {
            this.errorObj.stypErr = [];
            this.errorObj.ttypErr = [];
        ...
        async handleSubmit(e) {
            ...
            if (!this.checkEmptyErr()) {
                ...
                let data = {
                    book_styp: parseInt(this.orderObj.styp),
                    book_ttyp: parseInt(this.orderObj.ttyp),
